              ...
              <div className={classes.bottom_header}>
                <div className={classes.nav_bar_container}>
                  <ul className={classes.nav_bar}>
                    <li><Link className={classes.color} to="/">Today's Deals</Link></li>
                    <li><Link className={classes.color} to="/">Products</Link></li>
                    <li><Link className={classes.color} to="/">Brands</Link></li>
                    <li><Link className={classes.color} to="/">Clearance</Link></li>
                  </ul>
                </div>
              </div>
            </div>
